...
/**
 * <h2>Spring Data JPA 실습 Solution 코드와 관련있음</h2>
 *
 * OrderResponseDto 클래스의 memberId 필드는 {@link com.springboot.order.mapper.OrderMapper#orderToOrderResponseDto(Order)}에서
